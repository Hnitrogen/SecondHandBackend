...
func wireApp(confServer *conf.Server, confData *conf.Data, media *conf.Media, logger log.Logger, userClient v1.UserClient) (*kratos.App, func(), error) {
	...
	stuffService := service.NewStuffService(stuffUsecase, media)
